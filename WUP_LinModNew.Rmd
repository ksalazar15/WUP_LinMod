...
This graph shows that as grip strength goes up the simulation score goes up also. The spread of the points around the regression line in the grip plot are more spread out than the arm strength plot.
...
plot(SIMS~ARM,data=data)
abline (model.3, col='turquoise')
plot(SIMS~GRIP,data=data)
abline (model.3, col='orange')
```
